...
- Dashboard index view at `/audit` — paginated table of all audit entries (newest first, 25 per page) showing event badge, resource link, actor display name, and timestamp; includes empty state and Previous/Next pagination controls
